...
namespace WebApi.Controllers
{
    public class MoviesController : ApiController
    {
        ...
        public IEnumerable<Movie> GetMovieByStarringAndGenre(string starring, string genre)
        {
            return this.Search(starring, "", genre);
        }

        [HttpGet]
        [Route("api/movies/director/{director}/{genre}")]
        public IEnumerable<Movie> GetMovieByDirectorAndGenre(string director, string genre)
        {
            return this.Search("", director, genre);
        }

        private IEnumerable<Movie> Search(string starring = "", string director = "", string genre = "")
        {
